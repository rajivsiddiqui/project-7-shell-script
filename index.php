                        ...
                        <div class="col-md-9 p0">
                            <ul class="nav navbar-nav main_nav">
                              ...
                              <li><a href="#">Orange</a></li>
                                <li><a href="#">Leamon</a></li>
                                <li><a href="#">Dates</a></li>
                                <li><a href="#">Potatep</a></li>
                                <li><a href="#">Fish</a></li>
                            </ul>
                        </div>
        ...
        <section class="slider_area row m0">
            <div class="slider_inner">
                <div class="camera_caption">
                    <h2 class="wow fadeInUp animated">Online your Daily Shopping</h2>
                    <h5 class="wow fadeIn animated" data-wow-delay="0.3s">Find everything what you need</h5>
                ...
                <div class="col-md-3 col-sm-6 business_content">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>Purchase <?php echo $row['Name'] ?> at good price <span><?php echo $row['Price'] ?>$</span></p>
                        </div>
                    </div>
                </div>
        ...
        <footer class="footer_area row">
            <div class="container custom-container">
                ...
                <div class="copy_right_area">
                    <h4 class="copy_right">© Copyright Ecommerce | All Rights Reserved</h4>
                </div>
            </div>
        </footer>
